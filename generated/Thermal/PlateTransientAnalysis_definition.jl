...
@kwdef mutable struct PlateTransientAnalysisSpec <: AbstractTransientAnalysisSpec
  name::Symbol = :PlateTransientAnalysis
  ...
  var"model"::Union{Nothing, System} = DyadShip.Thermal.PlateHeatup(; name=:PlateHeatup)
end

function DyadInterface.run_analysis(spec::PlateTransientAnalysisSpec)
...
PlateTransientAnalysis(;kwargs...) = run_analysis(PlateTransientAnalysisSpec(;kwargs...))
export PlateTransientAnalysis, PlateTransientAnalysisSpec
