...
@kwdef mutable struct TemperatureDatasetTransientSpec <: AbstractTransientAnalysisSpec
  name::Symbol = :TemperatureDatasetTransient
  ...
  var"model"::Union{Nothing, System} = DyadShip.Thermal.TemperatureDatasetWithCapacitor(; name=:TemperatureDatasetWithCapacitor)
end

function DyadInterface.run_analysis(spec::TemperatureDatasetTransientSpec)
...
TemperatureDatasetTransient(;kwargs...) = run_analysis(TemperatureDatasetTransientSpec(;kwargs...))
export TemperatureDatasetTransient, TemperatureDatasetTransientSpec
