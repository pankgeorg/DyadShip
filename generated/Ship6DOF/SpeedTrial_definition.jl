...
@doc Markdown.doc"""
   SpeedTrial(; name, U0, J_shaft, rpm)
...
"""
@component function SpeedTrial(; name = nothing, U0=Float64(5), J_shaft=Float64(4000), rpm=Float64(100), kwargs...)
  isnothing(name) && throw(ArgumentError("""
    The `name` keyword must be provided. Please consider using the `@named` macro,
    like so:
  
    @named model = SpeedTrial()
  """))
