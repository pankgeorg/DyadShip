...
@doc Markdown.doc"""
   FourWingSails(; name, U0, J_shaft, rpm, sail_angle, wind_speed, wind_direction)
...
"""
@component function FourWingSails(; name = nothing, U0=Float64(7), J_shaft=Float64(4000), rpm=Float64(100), sail_angle=Float64(50), wind_speed=Float64(15), wind_direction=Float64(0), kwargs...)
  isnothing(name) && throw(ArgumentError("""
    The `name` keyword must be provided. Please consider using the `@named` macro,
    like so:
  
    @named model = FourWingSails()
  """))
