...
@doc Markdown.doc"""
   RudderReturn(; name, U0, J_shaft, rpm, rudder_deg, t_on, t_off)
...
"""
@component function RudderReturn(; name = nothing, U0=6.69, J_shaft=Float64(4000), rpm=Float64(100), rudder_deg=Float64(20), t_on=Float64(50), t_off=Float64(150), kwargs...)
  isnothing(name) && throw(ArgumentError("""
    The `name` keyword must be provided. Please consider using the `@named` macro,
    like so:
  
    @named model = RudderReturn()
  """))
  ...
  push!(__eqs, rudder_order ~ ifelse(t > t_on, ifelse(t < t_off, rudder_deg, 0), 0))
