...
@kwdef mutable struct OnOffConsumerTransientSpec <: AbstractTransientAnalysisSpec
  name::Symbol = :OnOffConsumerTransient
  ...
  var"model"::Union{Nothing, System} = DyadShip.Machinery.OnOffConsumerDuty(; name=:OnOffConsumerDuty)
end

function DyadInterface.run_analysis(spec::OnOffConsumerTransientSpec)
...
OnOffConsumerTransient(;kwargs...) = run_analysis(OnOffConsumerTransientSpec(;kwargs...))
export OnOffConsumerTransient, OnOffConsumerTransientSpec
