...
@kwdef mutable struct EventPeakSamplerTransientSpec <: AbstractTransientAnalysisSpec
  name::Symbol = :EventPeakSamplerTransient
  ...
  var"model"::Union{Nothing, System} = DyadShip.Machinery.EventPeakSamplerChirp(; name=:EventPeakSamplerChirp)
end

function DyadInterface.run_analysis(spec::EventPeakSamplerTransientSpec)
...
EventPeakSamplerTransient(;kwargs...) = run_analysis(EventPeakSamplerTransientSpec(;kwargs...))
export EventPeakSamplerTransient, EventPeakSamplerTransientSpec
